...
QT_MOC_LITERAL(1, 8, 16), // "notifyLowBattery"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 8), // "dischage"
QT_MOC_LITERAL(4, 35, 7) // "warning"

    },
    "Battery\0notifyLowBattery\0\0dischage\0"
    "warning"
};
...
void Battery::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->notifyLowBattery(); break;
        case 1: _t->dischage(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Battery::notifyLowBattery)) {
                *result = 0;
                return;
            }
        }
